...
> **Note: This project is complete but also has a companion in Rust! See the new and improved Rust version ([maze-tui](https://github.com/agl-alexglopez/maze-tui))! Now, this project is primarily an experimental repository to try new ideas from recent C++ standard additions. For example, modules, `std::span`, `atomics`, and many other features make an appearance here. As I learn more C++, this repository will updated with improved techniques.**
