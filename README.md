...
> **Note: This project is complete but also has a companion in Rust! See the new and improved Rust version ([multithreading-with-mazes-in-rust](https://github.com/agl-alexglopez/multithreading-with-mazes-in-rust))! The Rust version has new and improved programs and features.**
