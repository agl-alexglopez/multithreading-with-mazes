...
struct Demo_runner
{
    ...
    std::vector<Speed::Speed> builder_speed{
        Speed::Speed::speed_1, Speed::Speed::speed_2, Speed::Speed::speed_3,
        Speed::Speed::speed_4, Speed::Speed::speed_5, Speed::Speed::speed_6,
        Speed::Speed::speed_7};

    std::vector<Maze::Maze_style> wall_style{
        Maze::Maze_style::sharp,    Maze::Maze_style::round,
        Maze::Maze_style::doubles,  Maze::Maze_style::bold,
        Maze::Maze_style::contrast, Maze::Maze_style::spikes,
    };
    ...
    std::vector<Build_demo> modifications{Mods::add_cross_animated,
                                          Mods::add_x_animated};

    std::vector<Speed::Speed> solver_speed{
        Speed::Speed::speed_1, Speed::Speed::speed_2, Speed::Speed::speed_3,
        Speed::Speed::speed_4, Speed::Speed::speed_5, Speed::Speed::speed_6,
        Speed::Speed::speed_7};
...
main(int argc, char **argv)
{
    ...
    std::uniform_int_distribution<uint64_t> wall_chooser(
        0, demo.wall_style.size() - 1);
    std::uniform_int_distribution<uint64_t> builder_chooser(
        0, demo.builders.size() - 1);
    std::uniform_int_distribution<uint64_t> speed_chooser(
        0, demo.builder_speed.size() - 1);
    std::uniform_int_distribution<uint64_t> optional_modification(0, 5);
    std::uniform_int_distribution<uint64_t> modification_chooser(
    ...
    for (;;)
    {
        ...
        // We don't need loading time, it's just jarring to immediately
