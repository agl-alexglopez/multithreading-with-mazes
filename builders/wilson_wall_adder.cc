...
void join_walk_walls( Maze::Maze& maze, const Maze::Point& cur, const Maze::Point& next )
{
  ...
  Maze_utilities::build_wall_line( maze, cur );
  Maze_utilities::build_wall_line( maze, wall );
  Maze_utilities::build_wall_line( maze, next );
}
                         ...
                         Speed::Speed_unit speed )
{
  ...
  maze[cur.row][cur.col] &= static_cast<Maze::Square>( ~Maze::start_bit );
  maze[next.row][next.col] &= static_cast<Maze::Square>( ~Maze::start_bit );
  Maze_utilities::build_wall_line_animated( maze, cur, speed );
  Maze_utilities::build_wall_line_animated( maze, wall, speed );
  Maze_utilities::build_wall_line_animated( maze, next, speed );
}
...
bool continue_random_walks( Maze::Maze& maze, Random_walk& cur )
{
  if ( Maze_utilities::has_builder_bit( maze, cur.next ) ) {
    ...
    cur.walk = choose_arbitrary_point( maze, Maze_utilities::Parity_point::even );
