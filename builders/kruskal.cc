...
load_shuffled_walls(Maze::Maze &maze)
{
    std::vector<Maze::Point> walls = {};
    // The walls between cells to the left and right. Odd look left and right.
    ...
    // The walls between cells above and below. If row is even look above/below.
...
std::unordered_map<Maze::Point, int>
tag_cells(Maze::Maze &maze)
{
